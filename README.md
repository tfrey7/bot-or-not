...
<sub>This README is regenerated by [`scripts/regen-readme.ts`](./scripts/regen-readme.ts). Stamp: **v7.3.0, 2026-05-25**. Factor and archetype lists are pulled from [`src/factors.ts`](./src/factors.ts) so they can't drift.</sub>
