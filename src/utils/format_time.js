...
// Loaded as a plain script in every context that renders time strings.
...
(function () {
  ...
  function bonFormatPanelDate(ts) {
    const diffMs = Date.now() - ts;
    const min = 60_000;
    const hour = 60 * min;
    const day = 24 * hour;
  ...
  globalThis.bonFmtDuration = bonFmtDuration;
  globalThis.bonFormatDate = bonFormatDate;
  globalThis.bonFormatPanelDate = bonFormatPanelDate;
  globalThis.bonFmtTimestamp = bonFmtTimestamp;
  globalThis.bonPad2 = bonPad2;
})();
