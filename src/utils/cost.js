...
export const BON_MODEL_PRICING = {
  "claude-opus-4-7": {
    input: 15,
    output: 75,
    cacheRead: 1.5,
...
export function bonLookupPricing(model) {
  if (!model) {
    return null;
  }
...
export function bonEstimateCostUsd(usage, model, webSearchCount = 0) {
...
export function bonRecentCost(runs, days) {
