...
export function bonIsInvestigationStale(investigation) {
...
export function bonComputeVerdict(factors) {
...
export function bonNormalizeInvestigation(investigation) {
  if (!investigation) {
...
export function bonTopReasons(factors, count = 3) {
