...
import { bonReportsCalendarHeatmap } from "./calendar_heatmap.js";
import { bonReportsHourSection } from "./hour_heatmap.js";
...
export function bonReportsActivitySection(report) {
...
export function bonReportsActivityLoadingPlaceholder() {
  const wrap = document.createElement("div");
  wrap.className = "bon-detail-wrap";
  const title = document.createElement("p");
  title.className = "bon-detail-title";
