...
import { bonReportsFormatRunningTitle } from "./logic.js";
import { bonReportsOpenConfirmModal } from "./modals.js";

export function bonReportsApplyProgressVisual(btn, elapsedMs, expectedMs) {
  if (!expectedMs) {
    return;
  }
...
export function bonReportsRenderDeleteButton(username) {
  const btn = document.createElement("button");
  btn.type = "button";
