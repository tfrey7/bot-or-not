...
import { BON_REPORTS_DAY_NAMES, BON_REPORTS_MONTH_NAMES } from "./data.js";
import { bonReportsComputeEarliestFullyVisible } from "./logic.js";

export function bonReportsCalendarHeatmap(timestamps, activityData) {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    d.textContent = i % 2 === 1 ? BON_REPORTS_DAY_NAMES[i] : "";
