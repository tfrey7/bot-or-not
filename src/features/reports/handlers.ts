...
export async function bonReportsRecordReport(
  username: string,
...
export async function bonReportsGetState(
  username: string
...
export async function bonReportsGetReport(
  username: string
...
export async function bonReportsGetTags(): Promise<{
...
export async function bonReportsGetAll(): Promise<{
  reports: Record<string, Report>;
}> {
  return { reports: await bonReadReports() };
}

export async function bonReportsClearAll(): Promise<{ ok: boolean }> {
  await bonWriteReports({});
  return { ok: true };
}

export async function bonReportsDelete(
  username: string
...
export async function bonReportsSetUserStatus(
  username: string,
...
export async function bonReportsUpdateProfileStats(
  username: string,
...
export async function bonReportsUpdatePostStatus(
  permalink: string,
  status: string
): Promise<void> {
  const reports = await bonReadReports();
...
export async function bonReportsSetGoogleHarvest(
  username: string,
  query: string,
...
export async function bonReportsSetBotBouncerStatus(
  username: string,
...
export async function bonReportsLinkRing(
  usernames: string[]
...
export async function bonReportsUnlinkRing(
  usernames: string[]
