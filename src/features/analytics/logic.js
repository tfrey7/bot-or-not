...
//
// Loaded before index.js. Exposes:
//   bonAnalyticsCollect(reports)      -> investigations[]  (done + error)
//   bonAnalyticsSummarize(doneRuns)   -> summary stats object

(function () {
  "use strict";

  function bonAnalyticsCollect(reports) {
    const out = [];
  ...
  function bonAnalyticsSummarize(runs) {
    const s = {
      count: runs.length,
      totalCost: 0,
      totalDuration: 0,
  ...
  globalThis.bonAnalyticsCollect = bonAnalyticsCollect;
  globalThis.bonAnalyticsSummarize = bonAnalyticsSummarize;
})();
