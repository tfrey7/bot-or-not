...
export function bonAnalyticsSvgRoot(w, h, classes) {
...
export function bonAnalyticsSvgEl(name, attrs) {
...
export function bonAnalyticsSvgText(x, y, text, cls, anchor) {
...
export function bonAnalyticsEmptyChart(w, h, text) {
...
export function bonAnalyticsTimeAxisFormatter(spanMs) {
