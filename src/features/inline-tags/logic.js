...
export function bonInlineTagVariant(info) {
  if (info.verdict) {
    return info.verdict;
  }
...
export function bonInlineTagLabel(info, variant) {
  if (variant === "running") {
...
export function bonInlineTagTitle(info, variant) {
...
export function bonInlineTagIsAvatarLink(el) {
