...
import { bonRenderAnalytics } from "./features/analytics/index.js";
import { BON_REGION_INFO } from "./features/regions/data.js";
import {
  bonInferRegion,
  ...
  bonRegionForOffset,
} from "./features/regions/index.js";
import { bonFormatVerdict } from "./utils/format_text.js";
import { bonFmtDuration, bonFormatDate, bonPad2 } from "./utils/format_time.js";
import { bonBucketLevel, bonScoreLeaning } from "./utils/scoring.js";
import {
      ...
      if (next) {
        ...
        if (
          ...
          if (!report.activityData) {
            activityCellRef.replaceChildren(renderActivityLoadingPlaceholder());
          }
